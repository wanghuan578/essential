...
public class ServiceListRes implements org.apache.thrift.TBase<ServiceListRes, ServiceListRes._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceListRes> {
  ...
  public ServiceListRes setInfo_list(java.util.List<com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo> info_list) {
    this.info_list = info_list;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.info_list = new java.util.ArrayList<com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo>(_list0.size);
                com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServiceListRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.info_list != null) {
        oprot.writeFieldBegin(INFO_LIST_FIELD_DESC);
        {
          ...
          for (com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo _iter3 : struct.info_list)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetInfo_list()) {
        {
          ...
          for (com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo _iter4 : struct.info_list)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.info_list = new java.util.ArrayList<com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo>(_list5.size);
          com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo();
            _elem6.read(iprot);
