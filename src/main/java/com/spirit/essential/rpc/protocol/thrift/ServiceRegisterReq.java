...
public class ServiceRegisterReq implements org.apache.thrift.TBase<ServiceRegisterReq, ServiceRegisterReq._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceRegisterReq> {
  ...
  public com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo route; // required
  ...
  public ServiceRegisterReq(
    com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo route)
  {
    this();
    this.route = route;
  }
  ...
  public ServiceRegisterReq(ServiceRegisterReq other) {
    if (other.isSetRoute()) {
      this.route = new com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo(other.route);
    }
  }
  ...
  public com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo getRoute() {
    return this.route;
  }

  public ServiceRegisterReq setRoute(com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo route) {
    this.route = route;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ROUTE:
      if (value == null) {
        ...
        setRoute((com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // ROUTE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.route = new com.spirit.essential.rpc.protocol.thrift.ServiceRouteInfo();
