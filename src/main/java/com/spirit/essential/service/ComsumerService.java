...
public interface ComsumerService {
    String getServiceList(String serviceName, List<RouteInfo> serviceInfoList, PathChildrenCacheListener listener) throws MainStageException, IllegalAccessException, InstantiationException;
}
