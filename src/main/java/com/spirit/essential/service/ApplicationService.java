...
public interface ApplicationService {
    ...
    ServiceInfo getApplicationDetail(ServiceInfoDetailRequest host) throws IllegalAccessException, TbaException, InstantiationException, MainStageException, TbaException;
}
