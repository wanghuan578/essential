...
public class ServiceInfo implements org.apache.thrift.TBase<ServiceInfo, ServiceInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceInfo> {
  ...
  public ServiceInfo setService_name(String service_name) {
    this.service_name = service_name;
    return this;
  }
  ...
  public int compareTo(ServiceInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetService_weight()).compareTo(other.isSetService_weight());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetService_addr()).compareTo(other.isSetService_addr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetService_addr()) {
