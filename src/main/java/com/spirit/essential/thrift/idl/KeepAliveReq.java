...
public class KeepAliveReq implements org.apache.thrift.TBase<KeepAliveReq, KeepAliveReq._Fields>, java.io.Serializable, Cloneable, Comparable<KeepAliveReq> {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CURRENT_TIME_REQ:
      if (value == null) {
        ...
        setCurrent_time_req((Long)value);
      }
      break;
    ...
    case NETWORK_STATUS_LEVEL:
      if (value == null) {
        ...
        setNetwork_status_level((Short)value);
      }
      break;
  ...
  public int compareTo(KeepAliveReq other) {
    ...
    lastComparison = Boolean.valueOf(isSetCurrent_time_req()).compareTo(other.isSetCurrent_time_req());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetNetwork_status_level()).compareTo(other.isSetNetwork_status_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
