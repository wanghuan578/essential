...
public class UpdateResourceRes implements org.apache.thrift.TBase<UpdateResourceRes, UpdateResourceRes._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateResourceRes> {
  ...
  public String new_source_version; // required
  public String download_url; // required
  public String md5_value; // required
  public String feature_url; // required
  ...
  public String getNew_source_version() {
    return this.new_source_version;
  }

  public UpdateResourceRes setNew_source_version(String new_source_version) {
    this.new_source_version = new_source_version;
    return this;
  }
  ...
  public UpdateResourceRes setDownload_url(String download_url) {
    this.download_url = download_url;
    return this;
  }
  ...
  public UpdateResourceRes setMd5_value(String md5_value) {
    this.md5_value = md5_value;
    return this;
  }
  ...
  public UpdateResourceRes setFeature_url(String feature_url) {
    this.feature_url = feature_url;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case NEW_SOURCE_VERSION:
      if (value == null) {
        ...
        setNew_source_version((String)value);
      }
      break;
  ...
  public int compareTo(UpdateResourceRes other) {
    ...
    lastComparison = Boolean.valueOf(isSetUpdate_type()).compareTo(other.isSetUpdate_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpdate_type()) {
    ...
    lastComparison = Boolean.valueOf(isSetNew_source_version()).compareTo(other.isSetNew_source_version());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNew_source_version()) {
    ...
    lastComparison = Boolean.valueOf(isSetMd5_value()).compareTo(other.isSetMd5_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMd5_value()) {
    ...
    lastComparison = Boolean.valueOf(isSetFeature_url()).compareTo(other.isSetFeature_url());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFeature_url()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UpdateResourceRes(");
    boolean first = true;
