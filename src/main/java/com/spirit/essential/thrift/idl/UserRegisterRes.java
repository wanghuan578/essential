...
public class UserRegisterRes implements org.apache.thrift.TBase<UserRegisterRes, UserRegisterRes._Fields>, java.io.Serializable, Cloneable, Comparable<UserRegisterRes> {
  ...
  public UserRegisterRes setError_text(String error_text) {
    this.error_text = error_text;
    return this;
  }
  ...
  public UserRegisterRes setUser_id(String user_id) {
    this.user_id = user_id;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserRegisterRes(");
    boolean first = true;
